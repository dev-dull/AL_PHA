...
import 'package:planyr/features/template/data/templates.dart';
...
void main() {
  group('Board Templates', () {
    ...
    test('weekly template should have 7 columns', () {
      final weekly = defaultTemplates.firstWhere((t) => t.id == 'weekly');
    ...
    test('monthly template should have 31 columns', () {
      final monthly = defaultTemplates.firstWhere((t) => t.id == 'monthly');
    ...
    test('GTD template should have 7 context columns', () {
      final gtd = defaultTemplates.firstWhere((t) => t.id == 'gtd-contexts');
      expect(gtd.columns.length, 7);
      expect(gtd.columns.first.label, '@Phone');
    });

    test('daily hourly template should cover 6AM to 10PM', () {
      final daily = defaultTemplates.firstWhere((t) => t.id == 'daily-hourly');
    ...
    test('project tracker should have 4 columns', () {
      final project = defaultTemplates.firstWhere(
        (t) => t.id == 'project-tracker',
      );
