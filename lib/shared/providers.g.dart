...
final columnRepositoryProvider = Provider<ColumnRepository>.internal(
  columnRepository,
  name: r'columnRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$columnRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final markerRepositoryProvider = Provider<MarkerRepository>.internal(
  markerRepository,
...
final taskNoteRepositoryProvider = Provider<TaskNoteRepository>.internal(
  taskNoteRepository,
  name: r'taskNoteRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$taskNoteRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
